...
<head>
    ...
    <title>Witthayawiphat : หน้าประตูมอดินเเดง</title>
    <link rel="stylesheet" href="CSS/Modindaeng_Gate.css">
    ...
    <header>
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../Event.php">กิจกรรม</a>
                </li>
                <li class="nav-item">
                    <a class="nav-search" href="Searching.php"><button class="btn btn-light" type="button"><img src="../Resouces/Icons/Search_Black_24dp_X1.png" alt="Search"></a>
                </li>
            </ul>
        </nav>
    </header>
