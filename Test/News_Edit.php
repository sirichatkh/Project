...
<body>
    <header>
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
            ...
            <a class="navbar-brand" href="Home_Admin.php">Witthayawiphat</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link" href="Home_Admin.php">เเก้ไขหน้าหลัก</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Booking_Admin.php">เเก้ไขวิธีการจองห้องต่าง ๆ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="News_Admin.php">เเก้ไขข่าวสาร</a>
                </li>
            </ul>
        </nav>
    </header>
            ...
            <div class='row row-cols-1 row-cols-md-3 g-4'>
                <div class='col'>
                    <div class='card h-100'>
                        <a href='News_Edit.php?C_ID=<?php echo $row['C_ID']; ?>' class='text-decoration-none'>
