...
<head>
    ...
    <title>Witthayawiphat : เเก้ไขข้อมูลเเกลลอรี่</title>
    <link rel="stylesheet" href="CSS/Edit_G_Ad.css">
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <?php
        ...
        $sql = "SELECT * FROM gallery WHERE G_ID = '$POST["G_ID"]' ";
    ...
    ?>       
        <div class="Form_Edit">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="Image" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php echo $G_Image;?>"/>
            </div>
            <?php
            }
            ?>
